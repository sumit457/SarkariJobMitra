...
export type ToolKey = "image" | "convert" | "compress";

type ToolsWorkspaceProps = {
  forcedTool?: ToolKey;
  showChrome?: boolean;
  defaultConvertMode?: ConvertMode;
...
export function ToolsWorkspace({
  ...
  const requestedTool = forcedTool ?? searchParams.get("tool");
  ...
  function renderTool(tool: ToolKey) {
    ...
    if (tool === "convert") {
      return (
        <ConvertToolPanel
          embedded
          darkOverride={workspaceDark}
          showThemeToggle={false}
          defaultMode={defaultConvertMode}
        />
      );
    }
    return (
      <CompressToolPanel
        ...
        darkOverride={workspaceDark}
        showThemeToggle={false}
        defaultMode={defaultCompressMode}
      />
    );
  }
