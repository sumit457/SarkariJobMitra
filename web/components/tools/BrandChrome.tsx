...
export function BrandHeader({ eyebrow = "Free public tools" }: { eyebrow?: string }) {
  return (
    <header className="border-b border-slate-200 bg-gradient-to-r from-sky-100 via-cyan-50 to-indigo-100">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4">
        <Link href="/" className="flex items-center gap-3" aria-label="SarkariJobMitra home">
          ...
          <span>
            <span className="block text-xs font-semibold uppercase tracking-[0.22em] text-amber-700">{eyebrow}</span>
...
export function BrandFooter() {
  return (
    <footer className="border-t border-slate-200 bg-white px-4 py-6 text-slate-600">
